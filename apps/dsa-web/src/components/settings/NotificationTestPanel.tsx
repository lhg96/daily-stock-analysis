...
function getChannelOptions(language: 'ko' | 'en'): Array<{ value: NotificationTestChannel; label: string }> {
  return [
    { value: 'wechat', label: language === 'en' ? 'WeCom' : '위챗 워크' },
    { value: 'feishu', label: language === 'en' ? 'Feishu Webhook' : '페이수 Webhook' },
    { value: 'dingtalk', label: language === 'en' ? 'DingTalk' : '딩톡' },
    { value: 'telegram', label: 'Telegram' },
    { value: 'email', label: language === 'en' ? 'Email' : '이메일' },
    { value: 'pushover', label: 'Pushover' },
    { value: 'ntfy', label: 'ntfy' },
    { value: 'gotify', label: 'Gotify' },
    { value: 'pushplus', label: 'PushPlus' },
    { value: 'serverchan3', label: 'ServerChan3' },
    { value: 'custom', label: language === 'en' ? 'Custom Webhook' : '사용자 정의 Webhook' },
